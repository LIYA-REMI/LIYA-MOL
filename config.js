...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By liya' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919995399396@s.whatsapp.net' : process.env.TAG_REPLY,
